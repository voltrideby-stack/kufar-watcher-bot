...
KUFAR_SEARCH_URLS = os.getenv(
    "KUFAR_SEARCH_URLS",
"https://re.kufar.by/l/minsk/snyat/garazh?address=Московский+район%2C+Минск&cur=USD&gtsy=country-belarus~province-minsk~locality-minsk~coder_district-29"
)
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "8342529464:AAGw9ngsU0SD-W1keIHdv_eQiN3wutAK58U")
TELEGRAM_CHAT_ID = os.getenv("TELEGRAM_CHAT_ID", "584233853")
